    ...
    e.attachEvent && e.attachEvent("onunload", function () {
        ...
        if (!t.crossDomain || fe.cors) {
            ...
            return {
                send: function (r, i) {
                    var o, a = t.xhr(), s = ++un;
                    if (a.open(t.type, t.url, t.async, t.username), t.xhrFields) for (o in t.xhrFields) a[o] = t.xhrFields[o];
...
layui.define(["layer", "form"], function (t) {
    ...
    var s = function (t, i, a) {
        ...
        return x.hide = x.hide || function (t) {
            ...
            tips: 1, time: 0, skin: "layui-box layui-utils-face", maxWidth: 500, success: function (l, n) {
